      ...
      <section className="px-4 bg-toss-50 pb-6 sm:pb-8 -mt-16 sm:-mt-20 pt-16 sm:pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-center text-gray-700 text-base sm:text-lg font-medium mb-8 sm:mb-10 md:mb-12 leading-relaxed px-4">
            ...
            온ː숨의 기업 성장 코칭 프로그램.
            <span className="block mt-3 sm:mt-2 text-toss-600 font-bold">
              성과보다 '숨결'을 다룹니다.
            </span>
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-3 sm:space-y-4 text-gray-700 text-base sm:text-lg font-medium leading-relaxed">
            <p className="text-center">
              온ː숨의 기업 코칭은 조직의 성과 이전에{" "}
              <strong className="text-gray-900">사람의 회복과 연결</strong>을
              다룹니다.
            </p>
            <p className="text-center">
              우리는 구성원이 스스로 동기와 가치를 발견하도록 돕고, 리더가
              사람을 이해하는 리더십을 개발하도록 설계합니다.
              <br />팀 간의 관계, 소통, 정서적 안전감 같은{" "}
              <strong className="text-gray-900">'조직의 내면'</strong>을 다루는
              것이 핵심입니다.
            </p>
            <p className="text-center">
              온ː숨은 단기적인 퍼포먼스 향상보다{" "}
              <strong className="text-gray-900">지속 가능한 성장 문화</strong>를
              만드는 것을 목표로 합니다.
              <br />
              워크숍·리더십 코칭·정기 피드백 시스템을 통해
              <br />
              기업이{" "}
              <strong className="text-blue-600">'함께 숨 쉬는 조직'</strong>으로
              변화할 수 있도록 지원합니다.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                팀 간의 관계, 소통, 정서적 안전감 같은 '조직의 내면'을 다루는
                것이 핵심입니다.
              </p>
            </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="flex flex-col sm:flex-row items-start gap-4 p-4 sm:p-6 bg-gray-50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  팀 단위 혹은 전사 단위로 진행되는 상호작용 중심의 워크숍을
                  통해 조직 내면의 이슈를 발견하고 해결 방향을 모색합니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 p-4 sm:p-6 bg-gray-50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  리더들을 대상으로 한 1:1 또는 소그룹 코칭을 통해 사람을
                  이해하는 리더십을 구체적으로 실천할 수 있도록 돕습니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4 p-4 sm:p-6 bg-gray-50 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  프로그램 종료 후에도 지속적인 성장을 위한 피드백 시스템을
                  구축하여 '함께 숨 쉬는 조직'으로의 변화를 지원합니다.
                </p>
              </div>
            </div>
          </div>
