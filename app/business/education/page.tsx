        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-3 sm:space-y-4 text-gray-700 text-base sm:text-lg font-medium leading-relaxed">
            <p className="text-center">
              ...
              , 자신만의 길을 설계하는 힘을 기르도록 돕습니다.
            </p>
            <p className="text-center">
              학교·대학·청년단체와 협력하여{" "}
              <strong className="text-gray-900">진로·자존감·관계성장</strong>{" "}
              중심의 코칭 프로그램을 제공합니다.
              <br />
              단순한 프로그램이 아니라,{" "}
              <strong className="text-green-600">
                '왜 공부하는가', '어떤 사람이 되고 싶은가'
              </strong>
              를 함께 탐구하는 성찰형 커리큘럼입니다.
            </p>
            <p className="text-center">
              학생들이 비교와 불안을 넘어{" "}
              <strong className="text-gray-900">자기 가능성의 숨결</strong>을
              믿게 하는 것,
              <br />
              그것이 온ː숨의 교육 철학입니다.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                '왜 공부하는가', '어떤 사람이 되고 싶은가'를 함께 탐구하는
                성찰형 프로그램입니다.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                비교와 불안을 넘어 자기 가능성의 숨결을 믿게 하는 것이
                목표입니다.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                자신을 이해하는 것이 진로의 시작입니다. 스스로의 길을 설계하는
                힘을 기릅니다.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl">
              ...
              <p className="text-gray-600 text-sm">대학생 진로·성장 워크숍</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl">
              ...
              <p className="text-gray-600 text-sm">청년 성장·관계 코칭</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  '나는 누구인가', '무엇을 원하는가'를 탐구하는 성찰 중심
                  워크숍으로 자기 이해의 출발점을 마련합니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  단순한 직업 소개가 아닌, 자신의 가치관과 강점을 기반으로 한
                  진로 방향 설계를 지원합니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  또래 관계, 가족 관계에서의 소통 방법을 배우고 건강한 관계
                  맺기를 실천합니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  프로그램 종료 후에도 학생들이 스스로 성장할 수 있도록 자기
                  점검 도구와 후속 코칭을 제공합니다.
                </p>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-b from-white to-green-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
            교육기관 연계 프로그램에 대한 자세한 문의가 필요하신가요?
            <br />
            온ː숨이 함께하겠습니다.
          </p>
          <Link
