    ...
    <div className="min-h-screen bg-white pb-16" style={{ paddingTop: '80px' }}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-3 text-gray-700 text-lg font-medium" style={{ lineHeight: '18px' }}>
          ...
          <div className="p-8 bg-gradient-to-r from-blue-50 to-green-50 rounded-xl" style={{ marginTop: '30px', marginBottom: '30px' }}>
          ...
          <p className="text-center text-xl font-medium text-gray-800" style={{ marginTop: '30px', marginBottom: '20px' }}>
            성장은 거창한 도약이 아니라, 한 번의 진짜 숨에서 시작됩니다.
          </p>

          {/* 슬로건 */}
          <div className="pt-8 border-t-2 border-gray-200" style={{ marginTop: '20px' }}>
