    ...
    <div className="min-h-screen bg-white pb-12 sm:pb-20 pt-16 sm:pt-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-10 sm:mb-12 md:mb-16">
          ...
          <div className="space-y-2 sm:space-y-3 text-gray-700 text-base sm:text-lg font-medium leading-relaxed">
            <p className="text-lg sm:text-xl font-semibold text-gray-900">"청년이 자기 자신으로 숨 쉬며 성장하는 사회."</p>
        ...
        <section className="mb-10 sm:mb-12 md:mb-16">
          ...
          <ul className="space-y-2 sm:space-y-3 text-gray-700 text-base sm:text-lg font-medium leading-relaxed">
